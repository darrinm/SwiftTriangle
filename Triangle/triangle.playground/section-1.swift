...
//		initCommon()
	...
	func initCommon() {
		...
		var fragmentShaderSource = String.stringWithContentsOfFile("/Users/darrin/src/SwiftTriangle/Triangle/triangle120.frag", encoding: NSUTF8StringEncoding, error: nil)!
		var vertexShaderSource = String.stringWithContentsOfFile("/Users/darrin/src/SwiftTriangle/Triangle/triangle120.vert", encoding: NSUTF8StringEncoding, error: nil)!
